...
$(function(){
	...
	$(".Rut").keypress(function(e){
	    ...
	    if (keyCode) {
	        if (keyCode != 45 && keyCode != 107 && keyCode != 75) {
	...
	$(".campoTextarea").keyup(function (e)
	{

	    var text = $(this).val();
	    var maxLength = $(this).attr("maximo");
...
var App = function () {
    ...
    return {
        ...
        validarObligatoriosGeneral: function() {

		    var error = 0;
		    var lista = $('.obligatorio');
		
		    for (var i = 0; i < lista.length; i++) {
		        var campo = $(lista[i]);
		        var tipo = campo.prop("tagName");
		        var texto = campo.attr("nombre");
 		...
 		validarObligatorios: function(contendor) {
		    var error = 0;
		    var lista = $(contendor).find('.obligatorio');
        ...
        bloquearPantalla: function () {
            var el = jQuery($("html"));
            el.block({
                message: '<img src="/admin/img/ajax-loading5.gif" align="">',
                centerY: true,
                css: {
                    top: '10%',
                    border: 'none',
        ...
        ejecutarAjax: function (data, url, exito, error)
        {
            ...
            setTimeout(function ()
            {
                 $.ajax(
                {
                    ...
                    error: function (xhr, ajaxOptions, thrownError)
                    {
                        ...
                        App.MensajeAlerta("No se ha podido realizar la operación, intente nuevamente, si el error persiste comuníquese con el administrador.","Resultado Operación");
        ...
        ejecutarAjaxFile: function (data, url, exito, error)
        {
            App.bloquearPantalla();
